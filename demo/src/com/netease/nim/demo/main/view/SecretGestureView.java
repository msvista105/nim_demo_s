...
//        setWillNotDraw(false);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        LogUtil.d(TAG, "onLayout width:" + width + " height:" + height);
        for (int i = 0; i < getChildCount(); i++) {
            int pos_col = i % colsNum;
            int pos_row = i / colsNum;
            LogUtil.d(TAG, "onLayout pos_col:" + pos_col + " pos_row:" + pos_row);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < pathPoints.size(); i++) {
            ...
            if (points.length != 2) {
                LogUtil.d(TAG, "onDraw ---- points.length is error");
                break;
            }
...
//            child.getLocationInWindow(pos);
            LogUtil.d(TAG, "findChild x:" + x + " y:" + y + " pos[0]:" + pos[0] + " pos[1]:" + pos[1]);
    ...
    private void drawArrow(int lastIndex, int currentIndex) {
        ...
        LogUtil.d(TAG, "drawArrow  lastCenterX:" + lastCenterX + " lastCenterY:" + lastCenterY
...
//        colsNum = rowsNum = 3;
    ...
    class CircleView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            switch (lockType) {
                ...
                case ERROR:
                    ...
                    break;
                default:
                    LogUtil.d(TAG, "onDraw lockType error!");
            }
        ...
        @Override
        public boolean onTouchEvent(MotionEvent event) {
            LogUtil.d("CircleView", "onTouchEvent action:" + event.getAction());
            return super.onTouchEvent(event);
        }
